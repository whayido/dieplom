...
export const CardBalance2 = () => {
  return (
    <Card className="xl:max-w-sm bg-default-50 rounded-xl shadow-lg px-3 w-full">
      <CardBody className="py-5">
        <div className="flex gap-2.5">
          <Community />
          <div className="flex flex-col">
            <span className="text-default-900">Данные за сегодня</span>
            <span className="text-default-900 text-xs">+2400 человек</span>
          </div>
        </div>
